...
const CONTENT: Record<Locale, Content> = {
  am: {
    ...
    title: 'Աջակցել',
    lead:
      '«Դիտակետ»-ի գործունեությունը հիմնված է աջակիցների վրա։ Քո նվիրատվությունն ուղղակիորեն ֆինանսավորում է դիտորդների աշխատանքը 2 005 տեղամասերում, իրավաբանական աջակցությունը, ընտրությունների օրվա կապը և կայքի սպասարկումը։',
    bank: {
    ...
    swift: {
      ...
      intro:
        'Հայաստանից դուրս փոխանցումների համար (USD, EUR և այլն)։ Կոնկրետ արժույթի և թղթակից բանկի մանրամասների համար խորհրդակցեք քո բանկի հետ։',
      labels: {
        beneficiary: 'Ստացող (Beneficiary)',
        beneficiaryAddress: 'Ստացողի հասցե',
        account: 'Հաշվեհամար (IBAN/Account)',
        tin: 'ՀՎՀՀ (TIN)',
        bank: 'Բենեֆիցիարի բանկ',
    ...
    wallets: {
      ...
      intro: 'Արագ փոխանցում մոբայլ հավելվածից։',
      labels: {
        idram: 'IDram ID',
    ...
    transparency: {
      ...
      body:
        '«Դիտակետ»-ը ԿԸՀ-ի կողմից հավատարմագրված դիտորդական առաքելություն է, որը գործում է Հայաստանի Ընտրական օրենսգրքի շրջանակում։ Բոլոր նվիրատվությունները ուղղվում են դիտորդական գործունեությանը՝ դիտորդների ճանապարհածախսին, իրավաբանական աջակցությանը, ընտրությունների օրվա կապի և կայքի սպասարկման ծախսերին։ Անդորրագրի կամ ֆինանսական հարցերի համար գրիր՝ contact@ditaket.am։',
    },
  },
  en: {
