...
> = {
  am: {
    ...
    lead:
      '«Դիտակետ»-ը 2026 թվականի ՀՀ խորհրդարանական ընտրությունների (հունիսի 7) համար Կենտրոնական ընտրական հանձնաժողովի կողմից հավատարմագրված դիտորդական առաքելություն է։ Այս կայքը մեր առաքելության մի մասն է՝ ի լրումն տեղամասերում մեր դիտորդների ֆիզիկական ներկայության։',
    sections: [
      {
        heading: 'Ի՞նչ ենք անում',
        body:
          'Դիտակետի դիտորդները ներկա են քվեարկության ընթացքին, իրավաբանական աջակցություն են ցուցաբերում և արձանագրում են ընթացակարգային խախտումները։ Կայքը հնարավորություն է տալիս յուրաքանչյուր քաղաքացու անանուն հաղորդել խախտումների մասին, գտնել իր տեղամասը և հասկանալ իր իրավունքները։',
      },
      {
        heading: 'Մեր սկզբունքները',
        body:
          'Լռելյայն անանունություն — ոչ մի հաշիվ, ոչ մի հեռախոսահամար։ Թափանցիկություն — բոլոր հաղորդումները բացահայտ նշված են որպես «չստուգված»՝ մինչև մեր թիմի կողմից ստուգվելը։ Չեզոքություն — Դիտակետը չի սատարում որևէ կուսակցության կամ թեկնածուի և գործում է ՀՀ ընտրական օրենսգրքի շրջանակներում։',
      },
      {
        heading: 'Աղբյուրներ',
        body:
          'Տեղամասային տվյալները՝ ԿԸՀ-ի պաշտոնական ռեգիստրից (elections.am, 2 005 տեղամաս)։ Ուղիղ հեռարձակումները, երբ ակտիվ լինեն, տրամադրվում են ԿԸՀ համակարգի կողմից (ինչպես դա կազմակերպվել էր 2017 և 2021 թթ. ընտրություններին)։ Դիտորդների ու ԶԼՄ-ի՝ տեղամասում նկարահանելու իրավունքը՝ ՀՀ Ընտրական օրենսգիրք, Հոդված 6(12)։',
      },
      {
        heading: 'Փուլեր',
        body:
          'v1 — տեղամասերի ուղեցույց, քվեարկողի կրթություն, անանուն հաղորդումներ (հիմա)։ v2 — ԿԸՀ-ի ուղիղ հեռարձակումների ինտեգրում (հունիսի սկզբին)։ v3 — AI դիտորդ զննարկչում՝ բաշխված համայնքային մոնիթորինգով (2027+, փորձարարական)։',
      },
      {
        heading: 'Կապ',
        body:
          'Հաղորդումներն ուղարկվում են անմիջապես մեր մոդերացիայի թիմին։ Ցանկացած հարցի դեպքում կարող եք գրել մեր Facebook-յան էջին՝',
