  ...
  am: {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          'Անանունություն լռելյայն — ոչ մի հաշիվ, ոչ մի հեռախոսահամար։ Թափանցիկություն — բոլոր հաղորդումները բացահայտ նշված են որպես «չստուգված»՝ մինչև մեր թիմի ստուգումը։ Չեզոքություն — Դիտակետը ոչ մի կուսակցության կամ թեկնածուի կողմ չի ընտրում, գործում է Հայաստանի Ընտրական օրենսգրքի շրջանակում։',
      },
      {
        heading: 'Աղբյուրներ',
        body:
      ...
      },
      {
        heading: 'Փուլեր',
        body:
          'v1 — տեղամասերի ուղեցույց, քվեարկողի կրթություն, անանուն հաղորդումներ (հիմա)։ v2 — ԿԸՀ-ի կենդանի հեռարձակումների ինտեգրում (հունիսի սկզբին)։ v3 — բրաուզերային AI դիտորդ՝ բաշխված համայնքային մոնիթորինգով (2027+, փորձարարական)։',
      },
      {
        heading: 'Կապ',
        body:
          'Հաղորդումները ուղարկվում են ուղղակի մեր մոդերացիայի թիմին։ Միջազգային դիտորդական մարմինների կամ լրագրողների հետ համագործակցության համար՝ contact@ditaket.am (պլանավորված)։',
      },
    ],
  },
  en: {
