...
const CONTENT: Record<Locale, { title: string; updated: string; body: string[] }> = {
  am: {
    ...
    body: [
      ...
      'Քեզ արգելվում է ուղարկել քվեաթերթի լուսանկար (Հայաստանի Ընտրական օրենսգիրք, Հոդված 6)։ Քվեի գաղտնիության խախտումը հանցագործություն է։ Մենք ինքնաբերաբար ստուգում ենք վերբեռնված պատկերները և մերժում այնպիսիք, որոնք քվեաթերթեր են պարունակում։',
  ...
  en: {
    ...
    body: [
      ...
      'You may NOT upload a photograph of a ballot (Armenia Electoral Code, Article 6). Violating ballot secrecy is a crime. We screen uploaded images automatically and reject any containing ballots.',
  ...
  ru: {
    ...
    body: [
      ...
      'Запрещено загружать фотографию бюллетеня (Избирательный кодекс РА, статья 6). Нарушение тайны голосования — преступление. Мы автоматически проверяем загруженные изображения и отклоняем те, что содержат бюллетени.',
