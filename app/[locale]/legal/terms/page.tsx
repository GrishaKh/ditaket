...
const CONTENT: Record<Locale, { title: string; updated: string; body: string[] }> = {
  am: {
    ...
    body: [
      ...
      'Քեզ արգելվում է ուղարկել ակնհայտորեն կեղծ, վիրավորական կամ անպարկեշտ բովանդակություն, անձնանուններ կամ սպամ ու նույնաբովանդակ կրկնվող հաղորդումներ։ Կրկնակի խախտումները կարող են հանգեցնել քո IP մատնահետքի ժամանակավոր արգելափակմանը։',
      'Բոլոր հաղորդումները հրապարակվում են որպես «չստուգված»՝ մինչև գործընկեր կազմակերպության հաստատումը։ Դիտակետը որևէ իրավական պատասխանատվություն չի կրում քո հաղորդման բովանդակության հետևանքով։',
      'Մենք իրավունք ունենք հեռացնել ցանկացած հաղորդում, որը խախտում է այս պայմանները կամ Հայաստանի օրենքները։',
      'Կոդը՝ բաց (նախատեսվում է AGPL/MIT), տեղակայված է Vercel-ում։',
    ],
  },
  en: {
    title: 'Terms of use',
