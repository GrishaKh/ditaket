...
const CONTENT: Record<Locale, { title: string; updated: string; body: string[] }> = {
  am: {
    ...
    body: [
      ...
      'Հաղորդում ուղարկելիս մենք պահում ենք միայն հեշավորված տվյալներ՝ տեղամասի ID, կատեգորիա, ազատ շարադրանքով նկարագրություն, ժամանակ և կարճ հեշավորված «մատնահետք» (IP-ի, բրաուզերի տեսակի և լեզվի գաղտնագրված հեշը)։ Մատնահետքը օգտագործվում է միայն կրկնակի հաղորդումները զտելու և համակարգի ծանրաբեռնումը կանխելու համար։',
